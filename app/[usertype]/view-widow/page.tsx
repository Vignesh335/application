...
export default function ViewWidows() {
    const [subadmins, setSubadmins] = useState<any>([]);
    const [selectedWidow, setSelectedWidow] = useState<any>({});
    ...
    const handleEditClick = (record: any) => {
        ...
        if (selectedWidowData) {
            setSelectedWidow(selectedWidowData);
            setImageUrl(selectedWidowData.photo)
        }
    };

    const handleSubmit = async (e: React.FormEvent, selectedWidow: any) => {
        e.preventDefault();

        // Check if selectedWidow exists
        if (selectedWidow) {
            const formData = new FormData();

            Object.entries(selectedWidow).map(([key, value]: any) => {
                if (key !== 'photo') {
                    formData.append(key, value.toString());
                }
            })

            if (imageUrl !== selectedWidow.photo) {
    ...
    return (
        <AppLayout pathIndex={2} defaultpath={'/trustadmin'}>
            <div>
                ...
                <Modal
                    title="Edit Admin"
                    onOk={(e) => handleSubmit(e, selectedWidow)}
                    onCancel={() => {
                        setSelectedWidow({})
                        setImageUrl('')
                    }}
                    open={Object.keys(selectedWidow).length > 0 ? true : false}
                >
                    <div>
                        <div className="col-12">
                            ...
                            <Input
                                ...
                                value={selectedWidow.NAME_OF_THE_APPLICANTE}
                                onChange={(e: any) =>
                                    setSelectedWidow((prev: any) => ({
                                        ...prev!,
                        ...
                        <div className="col-12">
                            ...
                            <Input
                                ...
                                className="form-control"
                                name="DATE_OF_BIRTH"
                                value={selectedWidow.DATE_OF_BIRTH}
                                onChange={(e: any) =>
                                    setSelectedWidow((prev: any) => ({
                                        ...prev!,
                        ...
                        <div className="col-12">
                            ...
                            <Input
                                ...
                                value={selectedWidow.AADHAR_CARD_NUMBER}
                                onChange={(e: any) =>
                                    setSelectedWidow((prev: any) => ({
                                        ...prev!,
                        ...
                        <div className="col-12">
                            ...
                            <Input
                                ...
                                className="form-control"
                                name="HUSBAND_NAME"
                                value={selectedWidow.HUSBAND_NAME}
                                onChange={(e: any) =>
                                    setSelectedWidow((prev: any) => ({
                                        ...prev!,
                        ...
                        <div className="col-12">
                            ...
                            <Input
                                ...
                                className="form-control"
                                name="MARRIAGE_DATE"
                                value={selectedWidow.MARRIAGE_DATE}
                                onChange={(e: any) =>
                                    setSelectedWidow((prev: any) => ({
                                        ...prev!,
                        ...
                        <div className="col-12">
                            ...
                            <Input
                                ...
                                value={selectedWidow.NUMBER_OF_CHILDREN}
                                onChange={(e: any) =>
                                    setSelectedWidow((prev: any) => ({
                                        ...prev!,
                        ...
                        <div className="col-12">
                            ...
                            <Input
                                ...
                                value={selectedWidow.HUSBAND_PASSED_YEAR}
                                onChange={(e: any) =>
                                    setSelectedWidow((prev: any) => ({
                                        ...prev!,
                        ...
                        <div className="col-12">
                            ...
                            <Input
                                ...
                                className="form-control"
                                name="CAUSE_OF_DEATH"
                                value={selectedWidow.CAUSE_OF_DEATH}
                                onChange={(e: any) =>
                                    setSelectedWidow((prev: any) => ({
                                        ...prev!,
                        ...
                        <div className="col-12">
                            ...
                            <Input
                                ...
                                value={selectedWidow.RECEVING_PENSION}
                                onChange={(e: any) =>
                                    setSelectedWidow((prev: any) => ({
                                        ...prev!,
                        ...
                        <div className="col-12">
                            ...
                            <Input
                                ...
                                value={selectedWidow.HEALTH_PROBLEMS}
                                onChange={(e: any) =>
                                    setSelectedWidow((prev: any) => ({
                                        ...prev!,
                        ...
                        <div className="col-12">
                            ...
                            <Input
                                ...
                                value={selectedWidow.PRESENT_LIVING_STATUS}
                                onChange={(e: any) =>
                                    setSelectedWidow((prev: any) => ({
                                        ...prev!,
                        ...
                        <div className="col-12">
                            ...
                            <Input
                                ...
                                className="form-control"
                                name="Door_Number"
                                value={selectedWidow.Door_Number}
                                onChange={(e: any) =>
                                    setSelectedWidow((prev: any) => ({
                                        ...prev!,
                        ...
                        <div className="col-12">
                            ...
                            <Input
                                ...
                                className="form-control"
                                name="MANDAL_NAME"
                                value={selectedWidow.MANDAL_NAME}
                                onChange={(e: any) =>
                                    setSelectedWidow((prev: any) => ({
                                        ...prev!,
                        ...
                        <div className="col-12">
                            ...
                            <Input
                                ...
                                className="form-control"
                                name="DISTRICT_NAME"
                                value={selectedWidow.DISTRICT_NAME}
                                onChange={(e: any) =>
                                    setSelectedWidow((prev: any) => ({
                                        ...prev!,
                        ...
                        <div className="col-12">
                            ...
                            <Input
                                ...
                                className="form-control"
                                name="PHONE_NUMBER"
                                value={selectedWidow.PHONE_NUMBER}
                                onChange={(e: any) =>
                                    setSelectedWidow((prev: any) => ({
                                        ...prev!,
                        ...
                        <div className="col-12">
                            ...
                            <Input
                                ...
                                value={selectedWidow.REQUESTED_THROUGH}
                                onChange={(e: any) =>
                                    setSelectedWidow((prev: any) => ({
                                        ...prev!,
                        ...
                        <div className="col-12">
                            ...
                            <Input
                                ...
                                value={selectedWidow.REQUESTED_BY_NAME}
                                onChange={(e: any) =>
                                    setSelectedWidow((prev: any) => ({
                                        ...prev!,
                        ...
                        <div className="col-12">
                            ...
                            <Input
                                ...
                                value={selectedWidow.REQUESTED_PLACE}
                                onChange={(e: any) =>
                                    setSelectedWidow((prev: any) => ({
                                        ...prev!,
                        ...
                        <div className="col-12">
                            ...
                            <Input
                                ...
                                value={selectedWidow.REQUESTED_PHONE_NUMBER}
                                onChange={(e: any) =>
                                    setSelectedWidow((prev: any) => ({
                                        ...prev!,
                        ...
                        <div>
                            <Button
                                type="primary"
                                onClick={(e) => {
                                    const subadminToEdit = subadmins.filter((record: any) => record.id === selectedWidow.id)?.[0];
                                    handleSubmit(e, {
                                        ...subadminToEdit,
                                        status: '2'
                                    })
